...
heart = pickle.load(open(r'deploy/heart(logistic).sav', 'rb'))
parkinson = pickle.load(open(r'deploy/parkinson(svm).sav', 'rb'))
diabetes = pickle.load(open(r'deploy/diabetes_logistic.sav', 'rb'))
